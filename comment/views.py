...
def news_cm_add(request, pk):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            rand = News.objects.get(pk=pk).rand
            b = Comment(name=manager.name, email=manager.email, cm=cm, news_id=pk, date=today, time=time, rand=rand)
            b.save()
            ...
            rand = News.objects.get(pk=pk).rand
            b = Comment(name=name, email=email, cm=cm, news_id=pk, date=today, time=time, rand=rand)
            b.save()
